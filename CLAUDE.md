...
- **2026-04-25** — [Trading agent eval + research suite v2](docs/plans/2026-04-25-trading-eval-and-research-suite.md) — **full Russell 3000 backfill complete; 160 IC rows live.** 335,970 universe_snapshots (2,584 tickers × 65 trading days × 2 snapshots), Spearman IC across 4 regime buckets × 3 horizons. Dashboard: [/agents/eval](https://trading-bot.localhost:1355/agents/eval). Results: [full-backfill-results.md](docs/plans/results/2026-04-27-full-backfill-results.md), [eval-suite-results.md](docs/plans/results/2026-04-25-eval-suite-results.md), [layer1-findings.md](docs/plans/results/2026-04-25-layer1-findings.md). Headline findings: 5d-momentum / 20d-mean-revert split confirmed; `gap_pct` sign-flips by regime (+0.13 Risk-Off vs -0.075 Mixed); `bb_pos` is strongest 5d Risk-On predictor (IC +0.128). Next: Phase D agent decision replay.
